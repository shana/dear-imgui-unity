...
public class ImGuiWindow : DearImGui
{
	private static ImGuiWindow instance;
	...
	///
	/// If you call this with a delegate, but you forget to have the <see cref="ImGuiWindow"/> in the scene and/or
	...
	/// 
	/// If you call this with a delegate multiple times before the <see cref="ImGuiWindow"/> gets enabled,
	...
	/// If you're calling this too early (like, calling this on Awake when the <see cref="ImGuiWindow"/> isn't ready yet,
